...
class SignInForm(forms.Form):
    login = forms.CharField(widget=forms.TextInput(attrs={"placeholder": "Enter your login"}), label='',
                             required=True)
...
class SignUpForm(forms.Form):
    login = forms.CharField(widget=forms.TextInput(attrs={"placeholder": "Enter your first name"}), label="",
                           required=True)
